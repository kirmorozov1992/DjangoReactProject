        ...
        <header className="navbar-dark bg-dark navbar-sticky header-static">
            <nav className="navbar navbar-expand-lg">
                <div className="container">
                    ...
                    <Link className="navbar-brand" to="/">
                        <img className="navbar-brand-item dark-mode-item" src="https://png.pngtree.com/png-vector/20230120/ourlarge/pngtree-tree-logo-design-png-image_6566842.png" style={{ width: "50px" }} alt="logo" />
                    </Link>
