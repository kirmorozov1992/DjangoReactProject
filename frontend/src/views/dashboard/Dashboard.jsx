                                ...
                                <div className="card-body p-3">
                                    <div className="row">
                                        {posts?.slice(0, 3)?.map((p, index) => (
                                            <>
                                                <div className="col-12" key={p?.title + index}>
                                ...
                                <div className="card-body p-3">
                                    <div className="row">
                                        {comments?.slice(0, 3)?.map((c, index) => (
                                            <>
                                                <div className="col-12" key={c?.name + index}>
                                                    <div className="d-flex align-items-center position-relative">
                                                        <div className="avatar avatar-lg flex-shrink-0">
                                                            <img className="avatar-img" src="https://thumbs.dreamstime.com/b/default-avatar-profile-icon-vector-social-media-user-image-182145777.jpg" style={{ width: "100px", height: "100px", objectFit: "cover", borderRadius: "50%" }} alt="avatar" />
                                                        </div>
                                                        <div className="ms-3">
                                                            <p className="mb-1">
                                                                {" "}
                                    ...
                                    <div className="custom-scrollbar h-350">
                                        <div className="row">
                                            {noti?.slice(0, 3).map((n, index) => (
                                                <>
                                                    <div className="col-12" key={n?.type + index}>
